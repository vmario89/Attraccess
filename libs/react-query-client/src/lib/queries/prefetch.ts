...
export const prefetchUseReaderServiceGetReaders = (queryClient: QueryClient) => queryClient.prefetchQuery({ queryKey: Common.UseReaderServiceGetReadersKeyFn(), queryFn: () => ReaderService.getReaders() });
export const prefetchUseCardServiceCardControllerGetCards = (queryClient: QueryClient) => queryClient.prefetchQuery({ queryKey: Common.UseCardServiceCardControllerGetCardsKeyFn(), queryFn: () => CardService.cardControllerGetCards() });
