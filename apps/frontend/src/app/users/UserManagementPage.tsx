...
export const UserManagementPage: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto px-3 sm:px-4 py-5 sm:py-8 max-w-7xl" data-cy="user-management-page">
      <PageHeader title={t('title')} subtitle={t('subtitle')} backTo="/" icon={<Users className="w-6 h-6" />} data-cy="user-management-page-header" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mt-5 sm:mt-8">
        ...
        <div className="lg:col-span-1 order-1">
          <Card className="p-4 sm:p-6 shadow-sm" data-cy="user-management-user-search-card">
            ...
            <div className="mb-3 sm:mb-6">
              <UserSearch onSelectionChange={setSelectedUserId} placeholder={t('search')} data-cy="user-management-user-search-input" />
            </div>
          </Card>
        </div>
        ...
        <div className="lg:col-span-2 order-2">
          {isLoadingUser ? (
            <Card className="p-4 sm:p-6 flex flex-col items-center justify-center min-h-[250px] sm:min-h-[300px] text-center shadow-sm" data-cy="user-management-loading-user-card">
              <Loader className="w-10 h-10 sm:w-12 sm:h-12 text-primary-500 mb-3 sm:mb-4 animate-spin" data-cy="user-management-loading-user-spinner" />
            ...
            <Card className="p-4 sm:p-6 flex flex-col items-center justify-center min-h-[250px] sm:min-h-[300px] text-center shadow-sm" data-cy="user-management-select-user-prompt-card">
