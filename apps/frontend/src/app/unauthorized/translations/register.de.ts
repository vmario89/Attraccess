export default {
  ...
  subtitle:
    'Erstelle dein Konto, um Zeit an unseren 3D-Druckern, Lasercuttern und anderen coolen Maschinen zu buchen. Dein nächstes Projekt ist nur wenige Klicks entfernt!',
